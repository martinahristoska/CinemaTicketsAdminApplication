...
using CinemaTicketsAdminApplication.Models;
...
namespace CinemaTicketsAdminApplication.Controllers
{
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(Guid id)
        {
            ...
            string URL = "https://localhost:44376/api/Admin/GetDetailsForTicket";
        ...
        public FileContentResult CreateInvoice(Guid id)
        {
            ...
            string URI = "https://localhost:44376/api/Admin/GetDetailsForTicket";
            ...
            foreach (var item in result.TicketInOrders)
            {
                ...
                sb.AppendLine(item.SelectedTicket.Name + " with quantity of: " + item.Quantity + " and price of: " + item.SelectedTicket.Price + "$");
            }
        ...
        public FileContentResult ExportAllOrders()
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                string URI = "https://localhost:44376/api/Admin/GetOrders";
                ...
                for (int i = 1; i <= result.Count(); i++)
                {
                    ...
                    for (int p = 0; p < item.TicketInOrders.Count(); p++)
                    {
                        ...
                        worksheet.Cell(i + 1, p + 3).Value = item.TicketInOrders.ElementAt(p).SelectedTicket.Name;
                    }
                }
